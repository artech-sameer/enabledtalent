            ...
            <div class="container">
                <div class="col-md-8 col-lg-7 col-xl-5 mx-auto">
                    <div class="login-form">
                       ...
                       {{ html()->form('POST', route('company.registration.post'))->attribute('enctype', 'multipart/form-data')->id('storeForm')->open() }}
...
{{ html()->form()->close() }}
                        ...
                        <div class="login-footer">
                            ...
                            <p>Already have an account? <a href="{{ route('company.login.form') }}">Sign In.</a></p>
                        </div>
                    </div>
                </div>
            </div>
