...
<div class="row">
    <div class="col-12">
        <div class="page-title-box d-flex align-items-center justify-content-between">
           ...
           {{ Breadcrumbs::render('business-categories') }}
                    ...
                    <table id="dataTableAjax" class="display table-sm border-secondary dataTableAjax table table-striped table-bordered dom-jQuery-events" >
                        <thead>
                            <tr>
                                ...
                                <th>Description</th>
                                <th>Status</th>
                                @can(['edit_business_categories','delete_business_categories'])
                                <th>Action</th>
                                @endcan
            ...
            { "data": "status" }, 
            {
                ...
                render: function(data, type, row) {
                    if (type === 'display') {
                        ...
                        @can('delete_business_categories')
