                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-3 col-sm-12">
                        <div class="form-group{{ $errors->has('gender') ? ' has-error' : '' }}">
                            ...
                            {!! Form::select('gender', [1=>'Female', 2=>'Male', 3=>'Company'], null, ['id' => 'gender', 'class' => 'form-control', 'placeholder' => 'Gender']) !!}
                    ...
                    <div class="col-md-3 col-sm-12">
                        <div class="form-group{{ $errors->has('district') ? ' has-error' : '' }}">
                            ...
                            {!! Form::select('district', App\Models\District::where('state_id', old('state'))->pluck('name', 'id'), null, ['id' => 'district', 'class' => 'form-control getDistrict', 'placeholder' => 'Choose district']) !!}
                    ...
                    <div class="form-group col-md-3 col-sm-12">
                        <div class="form-group{{ $errors->has('city') ? ' has-error' : '' }}">
                            ...
                            {!! Form::select('city', App\Models\City::where('district_id', old('district'))->pluck('name', 'id'), null, ['id' => 'city', 'class' => 'form-control getCity', 'placeholder' => 'Choose City']) !!}
                    ...
                    <div class="form-group col-md-3 col-sm-12">
                        <div class="form-group{{ $errors->has('status') ? ' has-error' : '' }}">
                            ...
                            {!! Form::select('status', App\Models\Status::whereIn('id',[ 12, 15])->pluck('name', 'id'), null, ['id'=>'user_status','class' => 'form-control', 'placeholder' => 'User Staus']) !!}
                    ...
                    <div class="form-group col-md-3 col-sm-12">
                      ...
                      <div class="form-group col-md-3 col-sm-12" style="margin-top: 30px;">
                          {!! Form::submit('Save Data', ['class' => 'btn btn-info pull-right']) !!}
                      </div>
