<div class="app-menu navbar-menu">
    ...
    <div class="navbar-brand-box">
        ...
        <a href="{{ route('admin.dashboard.index') }}" class="logo logo-dark">
            <span class="logo-sm">
                <img class="img-fluid" src="{{asset(get_app_setting('favicon')??'admin-assets/images/favicon.png')}}" alt="" height="22">
            </span>
            <span class="logo-lg">
                <img class="img-fluid" src="{{asset(get_app_setting('logo')??'admin-assets/images/logo.png')}}" alt="" height="17">
            </span>
        </a>
        <!-- Light Logo-->
